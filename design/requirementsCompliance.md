...
| FR-WP07 | Fully-closed distinguishable from near-closed (Should) | ✅ **Met** | This is what the end switches are for. Status bit 3 says a stop was reached; the reported position says which. They asked for a *Should*; this design makes it mandatory. It no longer supervises the switch cable — the star topology (TDS §4.4, 2026-08-07) put the summing resistors on the PCB, and an open sensor cable now reads as a stop rather than as a fault |
