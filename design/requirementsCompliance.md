...
| FR-WP05 | Repeatability ≤ ±1 % over temperature | ⚠️ **Met on the firmware side; mechanism unproven** | FR-E03 firmware budget is ±0.1 % of full travel, stability ≤3 LSB (≈5.9 mm ≈ 0.29 %). Ratiometric operation cancels supply drift. **The draw-wire unit's own repeatability is not this device's to guarantee** and must be specified when it is bought |
| FR-WP06 | Absolute accuracy ≤ ±2 % (Should) | ⚠️ **Same split** | Firmware ±0.1 %; total depends on the mechanism |
