...
| [`wire_encoder/`](wire_encoder/) | `we_*` — absolute window-opening readout: 10 kΩ potentiometer on PA2, ratiometric 10-bit ADC. | **Not written.** API contract drafted in `lib/we/we.h`; the sibling project's potentiometer driver is the reference implementation |
